...
class SUB_PT_swing_data_master(Panel, SwingPropertyPanel):
    ...
    def draw(self, context):
        layout = self.layout
        arma = context.object
        layout.operator('sub.swing_copy_collisions_from_rig', icon='COPYDOWN', text='Copy Collisions from Rig')
        layout.operator('sub.swing_copy_bone_collisions_from_rig', icon='COPYDOWN',
                        text='Copy Swing Bone Collisions from Rig')
